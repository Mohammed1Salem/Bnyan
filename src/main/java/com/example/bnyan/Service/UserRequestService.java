...
public class UserRequestService {
    ...
    private void sendUserRequestNotification(Customer customer, Built built, UserRequest userRequest) {
        String webhookUrl = "http://localhost:5678/webhook-test/user-request-created";
    ...
    private void sendAcceptNotification(UserRequest userRequest) {
        String webhookUrl = "http://localhost:5678/webhook-test/user-request-accepted";
    ...
    private void sendRejectNotification(UserRequest userRequest) {
        String webhookUrl = "http://localhost:5678/webhook-test/user-request-rejected";
